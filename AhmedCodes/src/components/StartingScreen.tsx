  ...
  return (
    <section id="home" className="min-h-screen pt-5 flex flex-col items-center justify-center text-white font-mono select-none px-4 relative">
      <div className="flex items-center gap-6 text-center">
        <h1>
          <div className="text-[var(--color-custom-yellow)] font-normal text-[4rem] sm:text-[5rem] md:text-[6rem] lg:text-[7rem] xl:text-[8rem] animate-fade-in-up-scale-color">
            Ahmed
          </div>
          <div className="text-[var(--color-custom-yellow)] font-normal text-[4rem] sm:text-[5rem] md:text-[6rem] lg:text-[7rem] xl:text-[8rem] animate-fade-in-up-scale-color-delay-0-5">
            Alaa
          </div>
        </h1>
      ...
      <div className="flex items-center gap-4 mt-10 animate-fade-in-up-scale-delay-1">
        <p className="text-[var(--color-custom-yellow)] font-light text-[1.5rem] sm:text-[2rem] md:text-[2.5rem] lg:text-[3rem] xl:text-[3.5rem] tracking-wider font-mono">
          Frontend Developer
        </p>
